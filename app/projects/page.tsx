    ...
    <div style={{ background: "var(--bg)", minHeight: "100vh" }}>
      <div className="page-wrap" style={{ paddingTop: 60, paddingBottom: 88 }}>
        <div style={{ maxWidth: 780, margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "var(--disp)", fontStyle: "italic", fontSize: "clamp(34px, 5.5vw, 54px)", letterSpacing: "-0.04em", lineHeight: 1.02, fontWeight: 700, marginBottom: 12 }}>Projects</h1>
