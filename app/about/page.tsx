              ...
              <div style={{ marginBottom: 24 }}>
                {[
                  ...
                  },
                  {
                    ...
                    icon: <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.74l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />,
                  },
                  {
                    label: "Instagram", href: "https://www.instagram.com/abhijitdalal.26/", sub: "abhijitdalal.26",
                  ...
                  {
                    label: "College Email", href: "mailto:agdalal_b23@el.vjti.ac.in", sub: "agdalal_b23@el.vjti.ac.in",
                    icon: <path d="M22 10L12 4 2 10l10 6 10-6z" />, icon2: <path d="M6 12.5V17c0 1 2.5 3 6 3s6-2 6-3v-4.5" />, strokeIcon: true,
                  },
                  {
                    label: "Resume", href: "/projects/resume/resume.pdf", sub: "PDF · Download", download: true,
                    icon: <><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" /><path d="M14 2v6h6" /></>, strokeIcon: true,
                  },
                ].map(({ label, href, sub, download, icon, icon2, strokeIcon }) => (
                  <a
                    key={label}
                    href={href}
                    target={download || href.startsWith("mailto") ? undefined : "_blank"}
                    rel={download || href.startsWith("mailto") ? undefined : "noopener noreferrer"}
                    download={download ? "Abhijit_Dalal_Resume.pdf" : undefined}
                    className="hover-row"
                    style={{ display: "flex", alignItems: "center", gap: 12, padding: "9px 10px", textDecoration: "none", marginBottom: 2 }}
                  >
                    <svg width={18} height={18} viewBox="0 0 24 24" fill={strokeIcon ? "none" : "var(--sub)"} stroke={strokeIcon ? "var(--sub)" : "none"} strokeWidth={strokeIcon ? 1.8 : undefined} strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }} aria-hidden="true">
                      {icon}
                      {icon2}
                    </svg>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: 13, fontWeight: 500, color: "var(--ink)" }}>{label}</div>
                      <div style={{ fontSize: 11, color: "var(--faint)", fontFamily: "var(--mono)", marginTop: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{sub}</div>
                    </div>
                    <svg width={12} height={12} viewBox="0 0 16 16" fill="none" stroke="var(--faint)" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
                      {download ? <path d="M8 3v8m0 0l-3-3m3 3l3-3M3 13h10" /> : <path d="M4 12L12 4M5 4h7v7" />}
                    </svg>
                  </a>
                ))}
              </div>
